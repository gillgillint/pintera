            ...
            {!imageAsset ? (
              ...
              <div className='relative h-full '>
                ...
                <button
                  ...
                  onClick={() =>
                    setState((prev) => ({ ...prev, imageAsset: null }))
                  }
                >
                  <MdDelete />
                </button>
          ...
          <div className='flex flex-col'>
            <div>
              ...
              <select
                ...
                className='outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounded-md'
              >
            ...
            <div className='flex justify-end items-end mt-5 '>
              <button
                type='btnSubmit'
                className='bg-red-500 text-white p-2 rounded-full w-28 outline-none'
              >
                Save Pin
              </button>
            </div>
